...
<head>
    <meta charset="UTF-8">
    <title>Emploi du temps - <?= $classe['code'] ?> - <?= $classe['libelle'] ?></title>
...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3 no-print">
        <h2><i class="bi bi-calendar-week"></i> Emploi du temps - <?= $classe['code'] ?> - <?= $classe['libelle'] ?></h2>
        <div>
            ...
            <a href="<?= base_url('emploiDuTemps/form') ?>" class="btn btn-success btn-sm-custom"><i class="bi bi-plus-circle"></i> Ajouter</a>
        </div>
    </div>
    ...
    <div class="alert alert-light no-print">
        ...
        <span class="badge bg-secondary ms-3">Heure de début</span>
    </div>
                        ...
                        <?php foreach($jours as $jour): ?>
                            <td class="<?= isset($grille[$jour][$heure_debut]) ? 'seance-' . $grille[$jour][$heure_debut]['type_cours'] : '' ?>">
                                ...
                                ?>
                                    ...
                                    <div><i class="bi bi-person"></i> <?= $s['professeur_nom'] ?> <?= $s['professeur_prenom'] ?></div>
