<?php
/**
 * CodeIgniter Index Corrigé
 */

// 1. ENVIRONNEMENT SUR DEVELOPMENT POUR VOIR LES ERREURS
define('ENVIRONMENT', 'development');

// Cache les avertissements DEPRECATED de PHP 8.2 avec CI3
error_reporting(E_ALL & ~E_DEPRECATED & ~E_STRICT);

// 2. CONFIGURATION DES RAPPORTS D'ERREURS
switch (ENVIRONMENT)
{
    case 'development':
        error_reporting(E_ALL & ~E_DEPRECATED & ~E_STRICT);
